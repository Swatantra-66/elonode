      ...
      <main className="max-w-5xl mx-auto px-6 py-10 space-y-12">
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="space-y-4">
            ...
            <div className="bg-zinc-900/50 border border-zinc-800 rounded-md p-5 font-mono text-xs text-zinc-300 space-y-3">
              <p>
        ...
        <section className="space-y-4">
          ...
          <div className="bg-zinc-950 border border-zinc-800 rounded-md overflow-hidden">
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="text-[10px] uppercase tracking-widest text-zinc-500 border-b border-zinc-800 bg-zinc-900/40">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3 font-mono text-xs text-zinc-400">
              ...
              <li className="flex items-center gap-2">
                ...
                <strong className="text-zinc-200">Backend:</strong> Go (Golang)
                / Gin
              </li>
              <li className="flex items-center gap-2">
